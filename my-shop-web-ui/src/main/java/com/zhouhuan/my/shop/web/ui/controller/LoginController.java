...
import com.zhouhuan.my.shop.commons.utils.EmailSendUtils;
import com.zhouhuan.my.shop.web.ui.api.UserApi;
...
public class LoginController {
    ...
    public String login(TbUser tbUser, Model model, HttpServletRequest request) throws Exception {
        ...
        // 登录成功
            ...
            emailSendUtils.send("用户登录", String.format("用户 【%s】 登录 MyShop", user.getUsername()), "zhouhuan88888@163.com");
            // 将会员信息放入 Session
